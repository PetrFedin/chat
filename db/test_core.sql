...
INSERT INTO users(id, email) VALUES
  ('90000000-0000-0000-0000-000000000001', 'manager@example.com'),
  ('90000000-0000-0000-0000-000000000002', 'member2@example.com'),
  ('90000000-0000-0000-0000-000000000003', 'member3@example.com'),
  ('90000000-0000-0000-0000-000000000004', 'member4@example.com');
...
BEGIN
  BEGIN
    INSERT INTO commitments(id, organization_id, workspace_id, title, outcome, owner_id, requester_id, acceptor_id, source_message_id, status)
    VALUES ('40000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000002','Cross tenant reference','Must fail','90000000-0000-0000-0000-000000000002','90000000-0000-0000-0000-000000000001','90000000-0000-0000-0000-000000000003','30000000-0000-0000-0000-000000000001','proposed');
...
INSERT INTO commitments(id, organization_id, workspace_id, title, outcome, owner_id, requester_id, acceptor_id, source_message_id, status)
VALUES ('40000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000001','Valid task','Produce accepted result','90000000-0000-0000-0000-000000000002','90000000-0000-0000-0000-000000000001','90000000-0000-0000-0000-000000000003','30000000-0000-0000-0000-000000000001','proposed');
...
VALUES ('00000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000001','90000000-0000-0000-0000-000000000001','command-1','hash-1',now()+interval '1 day');
