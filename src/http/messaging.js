...
export async function handleMessaging(req,res,ctx,path,method){
  ...
  let m=path.match(new RegExp(`^/api/v1/conversations/${CONVERSATION_ID}/preferencesimport { randomUUID } from 'node:crypto';
import { Permission, hasPermission, requirePermission } from '../rbac.js';
import { allowedConversationKinds, allowedMessageKinds, cleanText, json, noContent, readJson, messageKindLabel } from './helpers.js';
...
,'i'));
  ...
  m=path.match(new RegExp(`^/api/v1/conversations/${CONVERSATION_ID}/pinsimport { randomUUID } from 'node:crypto';
import { Permission, hasPermission, requirePermission } from '../rbac.js';
import { allowedConversationKinds, allowedMessageKinds, cleanText, json, noContent, readJson, messageKindLabel } from './helpers.js';
...
,'i'));
  ...
  m=path.match(new RegExp(`^/api/v1/conversations/${CONVERSATION_ID}/membersimport { randomUUID } from 'node:crypto';
import { Permission, hasPermission, requirePermission } from '../rbac.js';
import { allowedConversationKinds, allowedMessageKinds, cleanText, json, noContent, readJson, messageKindLabel } from './helpers.js';
...
,'i'));
  ...
  m=path.match(new RegExp(`^/api/v1/messages/${MESSAGE_ID}/saveimport { randomUUID } from 'node:crypto';
import { Permission, hasPermission, requirePermission } from '../rbac.js';
import { allowedConversationKinds, allowedMessageKinds, cleanText, json, noContent, readJson, messageKindLabel } from './helpers.js';
...
,'i'));
  ...
  m=path.match(new RegExp(`^/api/v1/messages/${MESSAGE_ID}/pinimport { randomUUID } from 'node:crypto';
import { Permission, hasPermission, requirePermission } from '../rbac.js';
import { allowedConversationKinds, allowedMessageKinds, cleanText, json, noContent, readJson, messageKindLabel } from './helpers.js';
...
,'i'));
  ...
  m=path.match(new RegExp(`^/api/v1/messages/${MESSAGE_ID}/forwardimport { randomUUID } from 'node:crypto';
import { Permission, hasPermission, requirePermission } from '../rbac.js';
import { allowedConversationKinds, allowedMessageKinds, cleanText, json, noContent, readJson, messageKindLabel } from './helpers.js';
...
,'i'));
  ...
  m=path.match(new RegExp(`^/api/v1/messages/${MESSAGE_ID}import { randomUUID } from 'node:crypto';
import { Permission, hasPermission, requirePermission } from '../rbac.js';
import { allowedConversationKinds, allowedMessageKinds, cleanText, json, noContent, readJson, messageKindLabel } from './helpers.js';
