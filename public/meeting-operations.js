...
const observer=new MutationObserver(()=>{if(appVisible())decorateMeetingCenter()});observer.observe(document.body,{subtree:true,childList:true,attributes:true,attributeFilter:['hidden','class']});
